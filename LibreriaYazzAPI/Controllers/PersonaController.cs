...
namespace LibreriaYazzAPI.Controllers
{
    ...
    public class PersonaController : ControllerBase
    {
        ...
        private readonly IPersonaBusniess _PersonaBusniess;
        private readonly IMapper _mapper;
        public PersonaController(IMapper mapper)
        {
            _mapper = mapper;
            _PersonaBusniess = new PersonaBusniess(mapper);
        }
        ...
        public IActionResult Get()
        {
            ...
            return Ok(_PersonaBusniess.GetAll());
        }
        /// <summary>
        ...
        {
            return Ok(_PersonaBusniess.GetById(id));
        }
        ...
        {
            return Ok(_PersonaBusniess.Create(request));
        }
        ...
        //{
        //    GenericFilterResponse<PersonaResponse> res = _PersonaBusniess.GetByFilter(request);
        ...
        {
            List<PersonaResponse> res = _PersonaBusniess.CreateMultiple(request);
        ...
        {
            return Ok(_PersonaBusniess.Update(request));
        }
        ...
        {
            return Ok(_PersonaBusniess.Delete(id));
        }
