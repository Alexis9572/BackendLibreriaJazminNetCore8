...
namespace LibreriaYazzAPI.Controllers
{
    ...
    public class TipoDocumentoController : ControllerBase
    {
        ...
        private readonly ITipoDocumentoBusniess _TipoDocumentoBusniess;
        private readonly IMapper _mapper;
        public TipoDocumentoController(IMapper mapper)
        {
            _mapper = mapper;
            _TipoDocumentoBusniess = new TipoDocumentoBusniess(mapper);
        }
        ...
        public IActionResult Get()
        {
            ...
            return Ok(_TipoDocumentoBusniess.GetAll());
        }
        /// <summary>
        ...
        {
            return Ok(_TipoDocumentoBusniess.GetById(id));
        }
        ...
        {
            return Ok(_TipoDocumentoBusniess.Create(request));
        }
        ...
        //{
        //    GenericFilterResponse<TipoDocumentoResponse> res = _TipoDocumentoBusniess.GetByFilter(request);
        ...
        {
            List<TipoDocumentoResponse> res = _TipoDocumentoBusniess.CreateMultiple(request);
        ...
        {
            return Ok(_TipoDocumentoBusniess.Update(request));
        }
        ...
        {
            return Ok(_TipoDocumentoBusniess.Delete(id));
        }
