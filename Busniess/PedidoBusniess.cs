...
namespace Busniess
{
    public class PedidoBusniess : IPedidoBusniess
    {
       /*INYECCIÓN DE DEPENDECIAS*/
       #region DECLARACIÓN DE VARIABLES Y CONSTRUCTOR / DISPOSE
            private readonly IPedidoRepository _PedidoRepository;
            private readonly IMapper _mapper;
            public PedidoBusniess(IMapper mapper)
            {
                _mapper = mapper;
        ...
        #region START CRUD METHODS
         ...
         //GenericFilterResponse<PedidoResponse> ICRUDBusniess<PedidoRequest, PedidoResponse>.GetByFilter(GenericFilterRequest request)
         //{
