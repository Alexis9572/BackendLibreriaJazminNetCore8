...
namespace Busniess
{
    public class RolBusniess : IRolBusniess
    {
       /*INYECCIÓN DE DEPENDECIAS*/
       #region DECLARACIÓN DE VARIABLES Y CONSTRUCTOR / DISPOSE
            private readonly IRolRepository _RolRepository;
            private readonly IMapper _mapper;
            public RolBusniess(IMapper mapper)
            {
                _mapper = mapper;
        ...
        #region START CRUD METHODS
         ...
         //GenericFilterResponse<RolResponse> ICRUDBusniess<RolRequest, RolResponse>.GetByFilter(GenericFilterRequest request)
         //{
